 ...
 * platform-menu reuse; notepad/ is the second.)
 *
 ...
 * text specimens would open the demo instead of their real owner.
 */
export const apps: readonly AppManifest[] = [notepadApp, demoApp, explorerApp]
